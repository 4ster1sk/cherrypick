...
export * as 'flash/gen-token' from './endpoints/flash/gen-token.js';
...
export * as 'i/user-group-invites' from './endpoints/i/user-group-invites.js';
...
export * as 'notes/polls/translate' from './endpoints/notes/polls/translate.js';
...
export * as 'users/groups/delete' from './endpoints/users/groups/delete.js';
export * as 'users/groups/invitations/accept' from './endpoints/users/groups/invitations/accept.js';
export * as 'users/groups/invitations/reject' from './endpoints/users/groups/invitations/reject.js';
export * as 'users/groups/invite' from './endpoints/users/groups/invite.js';
export * as 'users/groups/joined' from './endpoints/users/groups/joined.js';
export * as 'users/groups/leave' from './endpoints/users/groups/leave.js';
export * as 'users/groups/owned' from './endpoints/users/groups/owned.js';
export * as 'users/groups/pull' from './endpoints/users/groups/pull.js';
export * as 'users/groups/show' from './endpoints/users/groups/show.js';
export * as 'users/groups/transfer' from './endpoints/users/groups/transfer.js';
export * as 'users/groups/update' from './endpoints/users/groups/update.js';
...
export * as 'official-tags/show' from './endpoints/official-tags/show.js';
export * as 'official-tags/update' from './endpoints/official-tags/update.js';
