...
function greet(props: { version: string; basedCherrypickVersion: string; basedMisskeyVersion: string; format: LogFormat }) {
...
export async function masterMain() {
	...
	try {
		...
		greet({ version: config.version, basedCherrypickVersion: config.basedCherrypickVersion, basedMisskeyVersion: config.basedMisskeyVersion, format: config.logging?.format ?? 'pretty' });
		showEnvironment();
