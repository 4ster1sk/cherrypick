	...
	<div class="_spacer" style="--MI_SPACER-w: 700px; --MI_SPACER-min: 16px; --MI_SPACER-max: 32px;">
		<SearchMarker path="/admin/settings" :label="i18n.ts.general" :keywords="['general', 'settings']" icon="ti ti-settings">
			<div class="_gaps_m">
					...
					<MkFolder :defaultOpen="slotProps.isParentOfTarget">
						...
						<div class="_gaps">
							...
							<SearchMarker :keywords="['suspended', 'software']">
								<MkFolder>
									<template #icon><SearchIcon><i class="ti ti-list"></i></SearchIcon></template>
				...
				<SearchMarker :keywords="['abuse', 'report']">
					<MkFolder>
				...
				<SearchMarker :keywords="['other', 'setting']">
					<MkFolder>
