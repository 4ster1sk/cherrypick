...
export type AdminAbortFullIndexRequest = operations['admin___abort-full-index']['requestBody']['content']['application/json'];
...
export type NotesAdvancedSearchRequest = operations['notes___advanced-search']['requestBody']['content']['application/json'];
export type NotesAdvancedSearchResponse = operations['notes___advanced-search']['responses']['200']['content']['application/json'];
...
export type NotesPollsTranslateRequest = operations['notes___polls___translate']['requestBody']['content']['application/json'];
export type NotesPollsTranslateResponse = operations['notes___polls___translate']['responses']['200']['content']['application/json'];
...
export type UsersGroupsJoinedRequest = operations['users___groups___joined']['requestBody']['content']['application/json'];
...
export type UsersGroupsOwnedRequest = operations['users___groups___owned']['requestBody']['content']['application/json'];
...
export type UsersTranslateRequest = operations['users___translate']['requestBody']['content']['application/json'];
export type UsersTranslateResponse = operations['users___translate']['responses']['200']['content']['application/json'];
